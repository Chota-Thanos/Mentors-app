...
function HeroArtwork() {
  return (
    <div className="relative mx-auto w-full max-w-[500px]">
      <div className="relative ml-auto aspect-[1.02] w-full max-w-[420px] overflow-hidden rounded-[30px] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a] shadow-[0_24px_70px_rgba(18,40,33,0.22)]">
        ...
        <div className="absolute bottom-[13%] left-[12%] h-[34%] w-[12%] rounded-[6px] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a] shadow-[0_16px_28px_rgba(0,0,0,0.2)]" />
        <div className="absolute bottom-[13%] left-[28%] h-[24%] w-[15%] rounded-[6px] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a] shadow-[0_12px_24px_rgba(0,0,0,0.18)]" />
        <div className="absolute bottom-[11%] left-[33%] z-10 h-[11%] w-[31%] rounded-[999px] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a] shadow-[0_16px_25px_rgba(0,0,0,0.22)]" />
        <div className="absolute bottom-[11%] left-[30.5%] h-[10.3%] w-[17%] -rotate-[8deg] rounded-[999px] border border-[#e7dec7] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a]" />
        <div className="absolute bottom-[11%] left-[46.5%] h-[10.3%] w-[17%] rotate-[8deg] rounded-[999px] border border-[#e7dec7] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a]" />
        <div className="absolute bottom-[8.5%] right-[2%] h-[34%] w-[36%] skew-x-[-10deg] rounded-[14px] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a] shadow-[0_18px_34px_rgba(0,0,0,0.26)]">
          <div className="absolute inset-x-[9%] top-[10%] bottom-[24%] rounded-[9px] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a]" />
        </div>
      </div>
      <div className="absolute bottom-[6%] left-[4%] rounded-[22px] bg-white dark:bg-[#0b1120] px-4 py-3 shadow-[0_18px_40px_rgba(15,23,42,0.12)]">
        <div className="flex items-start gap-3">
          <div className="mt-0.5 rounded-full bg-[#eef3ff] p-2 text-[#173aa9] dark:text-[#8ea9ff]">
  ...
  return (
    <div className="relative mx-auto w-full max-w-[332px]">
      ...
      <Image
        ...
        width={720}
        height={560}
        className="h-auto w-full rounded-[28px] border border-[#dce3fb] dark:border-[#1e2a4a] shadow-[0_18px_44px_rgba(80,103,170,0.12)]"
        priority={false}
      />
    </div>
  );
    ...
    <div className="min-h-screen bg-[#f6f8ff] text-[#192133]">
      <header className="sticky top-0 z-40 border-b border-[rgba(22,32,67,0.05)] bg-[rgba(246,248,255,0.92)] backdrop-blur-md">
        <div className="mx-auto flex min-h-[68px] w-full max-w-[1240px] items-center justify-between gap-3 px-4 py-3 sm:h-[74px] sm:px-6 lg:px-8">
          <div className="flex items-center gap-8 lg:gap-12">
            <Link href="/" className="text-[13px] font-semibold tracking-[-0.03em] text-[#17328f] dark:text-[#9bb5ff]">
              EliteIAS AI
            </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Link href="/login" className="hidden text-[13px] font-medium text-[#5e6885] transition hover:text-[#17328f] dark:text-[#9bb5ff] sm:inline-flex">
              Sign in
            </Link>
            <Link
              href="/signup"
            ...
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[#d7def4] bg-white dark:bg-[#0b1120] text-[#17328f] dark:text-[#9bb5ff] shadow-[0_10px_20px_rgba(21,31,76,0.08)] lg:hidden"
        ...
        {mobileMenuOpen ? (
          <div className="border-t border-[rgba(22,32,67,0.06)] bg-white dark:bg-[#0b1120]/95 lg:hidden">
            <nav className="mx-auto grid w-full max-w-[1240px] gap-2 px-4 py-4 sm:px-6">
              <Link href="#programs" onClick={() => setMobileMenuOpen(false)} className="rounded-2xl border border-[#dce3fb] dark:border-[#1e2a4a] bg-[#f8faff] dark:bg-[#0f172a] px-4 py-3 text-sm font-semibold text-[#17328f] dark:text-[#9bb5ff]">
                Programs
              </Link>
              <Link href="#support" onClick={() => setMobileMenuOpen(false)} className="rounded-2xl border border-[#dce3fb] dark:border-[#1e2a4a] bg-[#f8faff] dark:bg-[#0f172a] px-4 py-3 text-sm font-semibold text-[#17328f] dark:text-[#9bb5ff]">
                Mentorship
              </Link>
              <Link href="#tools" onClick={() => setMobileMenuOpen(false)} className="rounded-2xl border border-[#dce3fb] dark:border-[#1e2a4a] bg-[#f8faff] dark:bg-[#0f172a] px-4 py-3 text-sm font-semibold text-[#17328f] dark:text-[#9bb5ff]">
                AI Tools
              </Link>
              <Link href="#resources" onClick={() => setMobileMenuOpen(false)} className="rounded-2xl border border-[#dce3fb] dark:border-[#1e2a4a] bg-[#f8faff] dark:bg-[#0f172a] px-4 py-3 text-sm font-semibold text-[#17328f] dark:text-[#9bb5ff]">
                Resources
              </Link>
              <Link href="/login" onClick={() => setMobileMenuOpen(false)} className="rounded-2xl border border-[#dce3fb] dark:border-[#1e2a4a] bg-white dark:bg-[#0b1120] px-4 py-3 text-sm font-semibold text-[#5e6885]">
                Sign in
              </Link>
            </nav>
          </div>
      ...
      <main className="mx-auto w-full max-w-[1240px] px-4 pb-10 pt-8 sm:px-6 sm:pt-12 lg:px-8 lg:pt-16">
        <section className="grid items-center gap-8 sm:gap-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(420px,0.98fr)] lg:gap-12">
          <div className="max-w-[560px]">
            <h1 className="max-w-[520px] font-sans text-[34px] font-extrabold leading-[0.98] tracking-[-0.06em] text-[#1235ae] dark:text-[#a5bdf8] sm:text-[48px] lg:text-[70px]">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:flex-wrap sm:gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full bg-white dark:bg-[#0b1120] px-5 py-3 text-[13px] font-semibold text-[#17328f] dark:text-[#9bb5ff] shadow-[0_14px_28px_rgba(21,31,76,0.08)] transition hover:bg-[#f2f5ff]"
              >
                Meet Our Mentors
              </Link>
            </div>
        ...
        <section
          id="programs"
          className="mt-14 rounded-[28px] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a] px-5 py-7 sm:mt-16 sm:px-8 sm:py-10 lg:mt-24 lg:rounded-[34px] lg:px-10 lg:py-12"
        >
          <div className="grid items-center gap-8 sm:gap-10 lg:grid-cols-[minmax(0,1fr)_332px] lg:gap-16">
            <div className="max-w-[474px] lg:order-1">
              <h2 className="font-sans text-[28px] font-semibold leading-[1.08] tracking-[-0.04em] text-[#141b2d] dark:text-white sm:text-[40px]">
                Build a Strong Foundation for Prelims.
              </h2>
              <p className="mt-4 text-[14px] leading-7 text-[#636b86] dark:text-[#94a3b8]">
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_330px] lg:items-center">
            ...
            <div className="mx-auto w-full max-w-[320px] rounded-[18px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.06)] p-4 shadow-[0_20px_50px_rgba(0,0,0,0.22)]">
              <div className="flex items-center gap-3 rounded-[14px] bg-[rgba(255,255,255,0.04)] p-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a] text-[13px] font-bold text-[#172033]">
                  AS
                </div>
                <div>
              ...
              <Link
                href="/mentors/discover"
                className="mt-4 inline-flex w-full items-center justify-center rounded-full bg-white dark:bg-[#0b1120] px-4 py-3 text-[12px] font-medium text-[#1f2534] transition hover:bg-[#eff2fb]"
              >
                Find Your Mentor
              </Link>
            </div>
          ...
          <div className="mt-10 grid gap-4 text-left md:grid-cols-3">
            {toolCards.map((card) => {
              ...
              return (
                ...
                >
                  <div className="flex h-9 w-9 items-center justify-center rounded-[12px] bg-white dark:bg-[#0b1120] text-[#1739ac] shadow-[0_10px_20px_rgba(19,55,173,0.08)]">
                    <Icon className="h-4 w-4" />
                  </div>
                  <h3 className="mt-5 text-[16px] font-semibold tracking-[-0.03em] text-[#182033]">{card.title}</h3>
                  <p className="mt-3 text-[12px] leading-6 text-[#6c7590] dark:text-[#94a3b8]">{card.description}</p>
        ...
        <section
          id="resources"
          className="relative mt-14 overflow-hidden rounded-[24px] bg-gradient-to-b from-white to-[#f7f9ff] dark:from-[#0b1120] dark:to-[#0f172a] px-5 py-8 text-center text-white sm:px-6 sm:py-10 lg:mt-20 lg:rounded-[28px]"
        >
          ...
          <div className="relative">
            ...
            <Link
              href="/onboarding"
              className="mt-7 inline-flex items-center justify-center rounded-full bg-white dark:bg-[#0b1120] px-6 py-3 text-[13px] font-semibold text-[#1738aa] shadow-[0_14px_28px_rgba(0,0,0,0.14)] transition hover:bg-[#edf2ff]"
            >
              Apply as Educator
            </Link>
          </div>
      ...
      <footer className="border-t border-[rgba(22,32,67,0.06)] bg-[rgba(255,255,255,0.42)]">
        <div className="mx-auto flex w-full max-w-[1240px] flex-col gap-4 px-4 py-7 text-[11px] text-[#8088a0] sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-8">
          <div>
            <p className="text-[12px] font-semibold text-[#17328f] dark:text-[#9bb5ff]">EliteIAS AI</p>
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-2">
            <Link href="/onboarding" className="transition hover:text-[#17328f] dark:text-[#9bb5ff]">
              Apply as Educator
            </Link>
            <Link href="/login" className="transition hover:text-[#17328f] dark:text-[#9bb5ff]">
              Privacy Policy
            </Link>
            <Link href="/signup" className="transition hover:text-[#17328f] dark:text-[#9bb5ff]">
              Terms of Service
            </Link>
            <Link href="/mentors/discover" className="transition hover:text-[#17328f] dark:text-[#9bb5ff]">
              Contact Us
            </Link>
          </div>
        </div>
