...
export const metadata = {
  title: "Quiz Master AI Parser - Maths - UPSC Prep",
  description: "Quiz Master workspace for AI parsing and maths quiz creation linked to prelims tests.",
};

export default function QuizMasterMathsPage() {
  return (
    <AppLayout hideAdminLinks>
      <Suspense fallback={<div className="mx-auto max-w-6xl rounded-xl border border-slate-200 bg-white p-6 text-sm text-slate-600">Loading Quiz Master AI workspace...</div>}>
        <AIUserStudio quizKind="maths" mode="quiz_master" />
      </Suspense>
    </AppLayout>
  );
}
